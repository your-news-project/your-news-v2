...
public class SubNewsCommandService {
     ...
     * @param subNewsDto : 구독할 뉴스 ID 리스트를 포함한 요청 DTO
     */
    public void subscribeToNews(User user, SubNewsDto.Request subNewsDto) {
        List<News> newsList = newsService.readAllByIds(subNewsDto.ids());
    ...
    public void updateSubscribeNews(Long userId, SubNewsDto.Request subNewsDto) {
        ...
        this.subscribeToNews(user, subNewsDto);
    }
}
