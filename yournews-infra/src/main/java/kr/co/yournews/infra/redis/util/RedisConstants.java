...
public final class RedisConstants {
    ...
    public static final String STUDENT_SERVICE_CLICK_PREFIX = "student-service:click::";
    public static final String STUDENT_SERVICE_VIEW_PREFIX = "student-service:view::";
